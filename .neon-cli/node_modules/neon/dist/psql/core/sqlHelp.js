//#region src/psql/core/sqlHelp.ts
...
const findMatches = (topic) => {
	...
	return SQL_HELP.filter((entry) => {
		...
		for (let i = 0; i < needleToks.length; i++) if (!cmdToks[i].startsWith(needleToks[i])) return false;
		return true;
	});
};
/**
...
//#endregion
export { SQL_HELP, findMatches, formatEntry };
