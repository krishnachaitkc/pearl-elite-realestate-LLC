//#region src/psql/complete/queries.ts
const LIMIT = 1e3;
/** Tables (incl. partitioned tables). */
const Query_for_list_of_tables = `
...
`;
/** Materialized views. */
const Query_for_list_of_matviews = `
  SELECT pg_catalog.quote_ident(c.relname)
  FROM pg_catalog.pg_class c
  WHERE c.relkind = 'm'
    AND c.relname ILIKE $1
...
`;
/** Sequences. */
const Query_for_list_of_sequences = `
  SELECT pg_catalog.quote_ident(c.relname)
  FROM pg_catalog.pg_class c
  WHERE c.relkind = 'S'
    AND c.relname ILIKE $1
...
`;
/** Indexes. */
const Query_for_list_of_indexes = `
  SELECT pg_catalog.quote_ident(c.relname)
  FROM pg_catalog.pg_class c
...
`;
/** Foreign tables. */
const Query_for_list_of_foreign_tables = `
  SELECT pg_catalog.quote_ident(c.relname)
  FROM pg_catalog.pg_class c
  WHERE c.relkind = 'f'
    AND c.relname ILIKE $1
...
const Query_for_list_of_relations = `
  SELECT pg_catalog.quote_ident(c.relname)
  FROM pg_catalog.pg_class c
...
const Query_for_list_of_tables_views = `
  SELECT pg_catalog.quote_ident(c.relname)
  FROM pg_catalog.pg_class c
...
`;
/** Schemas. */
const Query_for_list_of_schemas = `
...
const Query_for_list_of_functions = `
...
`;
/** Extensions. */
const Query_for_list_of_extensions = `
...
const Query_for_list_of_available_extensions = `
...
`;
/** Databases. */
const Query_for_list_of_databases = `
...
`;
/** Languages. */
const Query_for_list_of_languages = `
...
`;
/** Tablespaces. */
const Query_for_list_of_tablespaces = `
...
`;
/** Operators. */
const Query_for_list_of_operators = `
...
const Query_for_list_of_set_vars = `
...
*/
const Query_for_values_of_enum_GUC = `
  SELECT val
  FROM (
...
const Query_for_list_of_access_methods = `
...
const Query_for_list_of_index_access_methods = `
  SELECT pg_catalog.quote_ident(amname)
  FROM pg_catalog.pg_am
  WHERE amname ILIKE $1
    AND amtype = 'i'
...
const Query_for_list_of_datatypes = `
...
`;
/** Publications. */
const Query_for_list_of_publications = `
...
`;
/** Subscriptions. */
const Query_for_list_of_subscriptions = `
...
*/
const Query_for_list_of_relations_in_schema = `
  SELECT pg_catalog.quote_ident(c.relname)
  FROM pg_catalog.pg_class c
...
*/
const Query_for_constraint_of_table = `
...
*/
const Query_for_constraint_of_table_in_schema = `
  SELECT pg_catalog.quote_ident(con.conname)
...
* paste-safe form.
*/
const Query_for_list_of_tables_for_constraint = `
...
*/
const Query_for_list_of_tables_for_constraint_in_schema = `
  SELECT DISTINCT pg_catalog.quote_ident(c.relname)
  FROM pg_catalog.pg_class c
...
*/
const Query_for_list_of_enum_values_quoted = `
  ...
  LIMIT ${LIMIT}
`;
const Query_for_list_of_enum_values_unquoted = `
  SELECT e.enumlabel
  FROM pg_catalog.pg_enum e, pg_catalog.pg_type t
  WHERE t.oid = e.enumtypid
    AND t.typname = $1
...
*/
const Query_for_list_of_timezone_names_unquoted = `
  SELECT name
  ...
  LIMIT ${LIMIT}
`;
const Query_for_list_of_timezone_names_quoted_out = `
  ...
  LIMIT ${LIMIT}
`;
const Query_for_list_of_timezone_names_quoted_in = `
  SELECT pg_catalog.quote_literal(name) AS name
  FROM pg_catalog.pg_timezone_names()
...
*/
const runCatalogQuery = async (conn, sql, pattern, extraParams = []) => {
	try {
...
//#endregion
export { Query_for_constraint_of_table, Query_for_constraint_of_table_in_schema, Query_for_list_of_access_methods, Query_for_list_of_available_extensions, Query_for_list_of_casts, Query_for_list_of_databases, Query_for_list_of_datatypes, Query_for_list_of_enum_values_quoted, Query_for_list_of_enum_values_unquoted, Query_for_list_of_extensions, Query_for_list_of_foreign_tables, Query_for_list_of_functions, Query_for_list_of_index_access_methods, Query_for_list_of_indexes, Query_for_list_of_languages, Query_for_list_of_matviews, Query_for_list_of_operators, Query_for_list_of_publications, Query_for_list_of_relations, Query_for_list_of_relations_in_schema, Query_for_list_of_roles, Query_for_list_of_schemas, Query_for_list_of_sequences, Query_for_list_of_set_vars, Query_for_list_of_subscriptions, Query_for_list_of_tables, Query_for_list_of_tables_for_constraint, Query_for_list_of_tables_for_constraint_in_schema, Query_for_list_of_tables_views, Query_for_list_of_tablespaces, Query_for_list_of_timezone_names_quoted_in, Query_for_list_of_timezone_names_quoted_out, Query_for_list_of_timezone_names_unquoted, Query_for_list_of_types, Query_for_list_of_views, Query_for_values_of_enum_GUC, runCatalogQuery };
